...
class FormTest extends TestCase
{
    ...
    public function testStoreTeamRedirectsIfNameIsAbsent()
    {
        ...
        $response->assertSessionHasErrors(["team_name"=>"Vous devez saisir un nom d'equipe."]);
    }
    ...
    public function testStoreTeamRedirectsIfNameIsTooShort()
    {
        ...
        $response->assertStatus(302);
        $response->assertRedirect('/teams/create');
        $response->assertSessionHasErrors(["team_name"=>"Le nom doit contenir au moins 3 caracteres."]);
    }
    ...
    public function testStoreTeamRedirectsIfNameIsTooLong() 
    {
        ...
        $response->assertStatus(302);
        $response->assertRedirect('/teams/create');
        $response->assertSessionHasErrors(["team_name"=>"Le nom doit contenir au plus 20 caracteres."]);
    }
    ...
    {    
        ...
        $response->assertStatus(302);
        $response->assertRedirect('/teams/create');
        $response->assertSessionHasErrors(["team_name"=>"Le nom d'equipe existe deja."]);
    }
    ...
    public function testStoreMatch()
    {
        ...
        $this->mock(Repository::class, function ($mock) {
            $mock->shouldReceive('insertMatch')->with(['team0' => 1, 'team1' => 2, 'm_date'=>'2048-10-05 10:22', 'score0'=>2, 'score1'=>4])->once()->andReturn(1);
            $mock->shouldReceive('updateRanking')->once();
        });
        $response = $this->withSession(['user' => ['id'=>1, 'email'=>'test@example.com']])
